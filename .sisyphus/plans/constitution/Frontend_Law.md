...
def blog_list_view(request):
    posts = BlogPost.objects.published().select_related('author').prefetch_related('tags')
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
    <div class="container">
        <a class="navbar-brand" href="/"><strong>AMW</strong> Portfolio</a>
...
### CSS Variables (from Design_Law.md)
```css
