...
# Skill entry
{
    ...
    'icon': 'bootstrap-icons/bootstrap-icons.svg#-bootstrap',
    'featured': True,
    'order': 1,
}
```
...
# SEO-friendly URLs
urlpatterns = [
    path('blog/', blog_list_view, name='list'),
    path('blog/<slug:slug>/', blog_detail_view, name='detail'),
    path('blog/tag/<slug:tag_slug>/', blog_tag_view, name='tag'),
    path('projects/', projects_list_view, name='list'),
    path('projects/<slug:slug>/', project_detail_view, name='detail'),
]
```
